...
from gan_model import Generator, Discriminator, weights_init_dcgan
...
def save_samples(step_tag: str):
    with torch.no_grad():
        ...
        utils.save_image(grid, os.path.join(OUT_DIR, f"samples_{step_tag}.png"))
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        for real, _ in loader:
            ...
            if global_step % 100 == 0:
                print(f"epoch {epoch:02d} | step {global_step:05d} | "
